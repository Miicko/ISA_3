    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/companies/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/equipments/*").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/equipments/**").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/reservedequipments/*").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/reservedequipments/**").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/appointments/*").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/appointments/**").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/equipments/*").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/equipments/**").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/reservedequipments/*").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/reservedequipments/**").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/users/*").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/users/**").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/appointments/*").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/appointments/**").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/companies/*").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/companies/**").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/equipments/*").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/equipments/**").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/reservedequipments/*").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/reservedequipments/**").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/appointments/*").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/appointments/**").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/api/v1/appointments/*").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/appointments/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/users/*").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/users/**").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/complaints/*").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/complaints/**").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/complaints/*").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/complaints/**").hasRole("USER")
